...
# Config
st.set_page_config(
    page_title='HPD Analysis Dashboard',
    page_icon='🏘️',
    layout='wide',
...
st.markdown(
    """
    Below is an interactive map tool displaying affordable housing financed by HPD programs across NYC 2022 Census Block Groups. 
...
def update_map(unit_type):
    if unit_type == 'Extremely Low Income Units':
        ...
        m.add_data(HPD_AFF_Build_BG22_geo, 
